...
sys.path.append("..")
"""Local imports"""
from misc.utils import currency
...
class Company:
    ...
    def __repr__(self):
        return "\nCompany<company_name, symbol, sector, industry, business_summary, country, employee_count, market_cap, float_shares, is_esg_populated>"
